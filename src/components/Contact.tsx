  ...
  return (
    <section id="contact" className="bg-cream py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <Reveal>
          <div className="overflow-hidden rounded-3xl bg-foreground shadow-2xl transition-shadow duration-500 hover:shadow-[0_24px_60px_rgba(44,42,38,0.25)]">
            <div className="grid lg:grid-cols-2">
              <div className="p-10 md:p-14">
                <p className="section-label text-gold">{dict.contact.label}</p>
                <div className="gold-line gold-line-animate my-4" />
                <h2 className="font-display text-3xl font-semibold text-white md:text-4xl">
                  {dict.contact.title}
                </h2>
                <p className="mt-4 text-white/75">{dict.contact.subtitle}</p>
                ...
                <div className="mt-10 space-y-4">
                  <a
                    ...
                    className="flex items-center gap-4 rounded-xl bg-[#25D366]/10 px-5 py-4 text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#25D366]/20 hover:shadow-lg"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/60">{dict.contact.whatsappHint}</p>
                    </div>
                  </a>
                  ...
                  >
                    <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0088cc] text-white">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    className="flex items-center gap-4 rounded-xl bg-white/5 px-5 py-4 text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/10 hover:shadow-lg"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/60">{dict.contact.callHint}</p>
                    </div>
                  </a>
                </div>
              </div>
